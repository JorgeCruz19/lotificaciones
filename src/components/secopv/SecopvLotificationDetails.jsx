  ...
  return (
    <div className="pt-32">
      <div className="z-20 absolute left-4 top-20 bg-white py-2 md:py-4 px-2 md:px-6 rounded-md w-1/2 md:w-1/4">
        ...
        <p className='mb-2'><strong>Ubicación:</strong> { ubicacion ? ubicacion : <span className='px-2 py-1 rounded-full text-white bg-red-400 font-semibold text-sm w-max'>No disponible</span> }</p>
        <p><strong>Teléfono:</strong> { telefono ? telefono : <span className='px-2 py-1 rounded-full text-white bg-red-400 font-semibold text-sm w-max'>No disponible</span> }</p>
      </div>
