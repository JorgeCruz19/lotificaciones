...
const EcomuniLotificationDetails = () => {
  const {departamento ,lotificacion} = useParams()
  const data  = getLotificationDetails(departamento, lotificacion);
  ...
  return (
    <div className="relative pt-32">
      <div className="z-20 absolute left-0 top-20 bg-white py-2 md:py-4 px-2 md:px-6 rounded-md w-1/2 md:w-1/4">
        <h2 className="text-xl sm md:text-3xl text-center font-bold text-slate-800 mb-5">{ nombre }</h2>
